...
import { Breakpoint, ListBreakpointsResponse } from './types/api-types';
export declare class Controller extends common.ServiceObject {
     ...
     * body)
     */
    listBreakpoints(debuggee: Debuggee, callback: (err: Error | null, response?: http.ServerResponse, body?: ListBreakpointsResponse) => void): void;
    /**
